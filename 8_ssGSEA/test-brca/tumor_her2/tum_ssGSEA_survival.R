...
setwd(
  "/home/yyx/R/Project/R_code/SigBridgeR/Tmp/ssGSEA/test-brca/tumor_her2"
)
...
qs::qsave(es.mat, "tum_her2_ssgsea_score.qs") # PID=40521
cli::cli_alert_success("ssGSEA done!")
es.mat <- qs::qread("tum_her2_ssgsea_score.qs")
...
seurat_GSE42568 = qs::qread(
  file.path(data_path, "GSE42568_her2_merged_seurat.qs"),
  nthreads = 4L
)
...
plot_dir = "/home/yyx/R/Project/R_code/SigBridgeR/Tmp/ssGSEA/test-brca/tumor_her2/plot"
...
seurat_GSE162228 <- qs::qread(
  file.path(data_path, "GSE162228_her2_merged_seurat.qs"),
  nthreads = 4L
)
...
seurat_TCGA_BRCA <- qs::qread(
  file.path(data_path, "tcga_her2_merged_seurat.qs"),
  nthreads = 4L
)
...
ragg::ang_png(
  file = file.path(plot_dir, "tum_ssGSEA_her2_survival_heatmap.png"),
  width = 16,
  height = 10
)
draw(
