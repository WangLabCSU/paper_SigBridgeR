...
# ! brca-GSE161529_tnbc, bulk - GSE42568, pheno-binary
...
plot_dir = "/home/yyx/R/Project/R_code/SigBridgeR/Tmp/ssGSEA/test-brca/tumor_tnbc/binary_plot"
...
ragg::ang_png(
  file = file.path(plot_dir, "ssGSEA_tnbc_binary_heatmap.png"),
  width = 16,
  height = 10
)
draw(
