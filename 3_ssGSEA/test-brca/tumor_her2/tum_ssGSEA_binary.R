...
# ! brca-GSE161529_her2, bulk - GSE42568, pheno-binary
...
plot_dir = "/home/yyx/R/Project/R_code/SigBridgeR/Tmp/ssGSEA/test-brca/tumor_her2/binary_plot"
...
ragg::ang_png(
  file = file.path(plot_dir, "ssGSEA_her2_binary_heatmap.png"),
  width = 16,
  height = 10
)
draw(
...
p <- ggplot(mean_scores, aes(x = Sample, y = screen, fill = mean_score)) +
  ...
  labs(
    ...
    subtitle = "sc-GSE161528 HER2, binary phenotype",
    y = "Mean ssGSEA Score",
    x = "Bulk Sample"
  ) +
  theme_classic() +
