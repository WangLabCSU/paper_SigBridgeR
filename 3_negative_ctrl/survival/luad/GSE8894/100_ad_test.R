...
setwd(file.path(usethis::proj_path(), "3_negative_ctrl/survival/luad/GSE8894"))

seurat <- qs::qread(
  "/home/data/sigbridger/benchmark_data/lung/luad/survival_lung_GSE8894_merged_seurat.qs",
  nthreads = 4L
)
