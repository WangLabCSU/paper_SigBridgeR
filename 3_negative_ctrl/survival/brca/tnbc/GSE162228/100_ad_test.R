...
setwd(file.path(
  usethis::proj_path(),
  "3_negative_ctrl/survival/brca/tnbc/GSE162228"
))

seurat <- qs::qread(
  "/home/data/sigbridger/benchmark_data/brca/TNBC/survival_TNBC_GSE162228_merged_seurat.qs",
  nthreads = 4L
)
scores <- data.table::fread(
  "tnbc_sur_100reps_neg_ctrl_stat.csv"
)
