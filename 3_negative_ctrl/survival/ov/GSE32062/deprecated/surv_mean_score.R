...
setwd(
  '/home/yyx/R/Project/R_code/SigBridgeR/Tmp/ssGSEA_negative_compare/survival/ov/GSE32062'
)
...
bubble <- ggplot2::ggplot(
  ...
  ggplot2::labs(
    ...
    subtitle = "sc-GSE165897, bulk-GSE32062",
    y = "Mean ssGSEA Score",
    x = "Group"
  ) +
...
ggplot2::ggsave(
  filename = 'Neg_ctrl_ov_GSE32062_mean_score.png',
  bubble,
  dpi = 400,
  width = 6,
  height = 6
