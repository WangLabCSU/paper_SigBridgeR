...
mean_scores <- data.table::fread(
  "Tmp/ssGSEA_negative_compare/binary/brca/her2/TCGA_BRCA/her2_bi_100reps_neg_ctrl_stat.csv"
)
...
ggplot2::ggsave(
  "Tmp/ssGSEA_negative_compare/binary/brca/her2/TCGA_BRCA/her2_bi_100reps_neg_ctrl_stat.png",
  p,
  width = 8,
  height = 6,
  dpi = 400
