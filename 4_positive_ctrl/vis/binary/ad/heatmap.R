...
data.table::fwrite(
  combined,
  file = "vis/binary/ad/binary_ad_test_data.csv"
)

cli::cli_alert_success(
  "Combined test results saved to {.file binary_ad_test_data.csv}"
)
...
htmap_dir <- "vis/binary/ad/heatmap"
...
purrr::walk(c("pos", "neg"), function(ssgsea_type) {
  file_name <- glue::glue("ad_{ssgsea_type}marker_htmap.png")
