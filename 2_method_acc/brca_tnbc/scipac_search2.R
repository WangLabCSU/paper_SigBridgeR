...
if (!dir.exists("stats/scipac2/part1")) {
  dir.create("stats/scipac2/part1", recursive = TRUE)
}
...
data.table::fwrite(
  all_results,
  file = "stats/scipac_label_mat2_part1.csv",
  row.names = TRUE
)

cli::cli_alert_success(crayon::green(
  "(2) scipac random search part1 completed."
))
...
# ! To avoid recomputing, file cache is used
if (!dir.exists("stats/scipac2/part2")) {
  dir.create("stats/scipac2/part2", recursive = TRUE)
}
...
data.table::fwrite(
  all_results,
  file = "stats/scipac_label_mat2_part2.csv",
  row.names = TRUE
)

cli::cli_alert_success(crayon::green(
  "(2) scipac random search part2 completed."
))
