...
if (!dir.exists("stats/degas2/part1")) {
  dir.create("stats/degas2/part1", recursive = TRUE)
}

# * run DEGAS
if (!file.exists("stats/degas_label_mat2_part1.csv")) {
  res_list <- lapply(
  ...
  cli::cli_alert_info("Found degas_label_mat2_part1.csv, skip")
}
...
if (!dir.exists("stats/degas2/part2")) {
  dir.create("stats/degas2/part2", recursive = TRUE)
}


# * run DEGAS
if (!file.exists("stats/degas_label_mat2_part2.csv")) {
  res_list <- lapply(
  ...
  cli::cli_alert_info("Found degas_label_mat2_part2.csv, skip")
}
...
if (!dir.exists("stats/degas2/part3")) {
  dir.create("stats/degas2/part3", recursive = TRUE)
}

if (!file.exists("stats/degas_label_mat2_part3.csv")) {
  res_list <- lapply(
  ...
  cli::cli_alert_info("Found degas_label_mat2_part3.csv, skip")
}
