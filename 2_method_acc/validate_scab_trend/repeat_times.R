...
tnbc_scab <- data.table::fread(
  "2_method_acc/brca_tnbc/arg_samples/scab_arg_samples1.csv"
)
...
her2_scab_repeat_times_f1 <- robust_kendall_perm(
  x = her2_scab$repeat_times,
  y = her2_scab$F1,
  seed = 123
)
her2_scab_repeat_times_acc <- robust_kendall_perm(
  x = her2_scab$repeat_times,
  y = her2_scab$Accuracy,
  seed = 124
)
tnbc_scab_repeat_times_f1 <- robust_kendall_perm(
  x = tnbc_scab$repeat_times,
  y = tnbc_scab$F1,
  seed = 125
)
tnbc_scab_repeat_times_acc <- robust_kendall_perm(
  x = tnbc_scab$repeat_times,
  y = tnbc_scab$Accuracy,
  seed = 126
)
all_scab_repeat_times_f1 <- robust_kendall_perm(
  x = c(her2_scab$repeat_times, tnbc_scab$repeat_times),
  y = c(tnbc_scab$F1, her2_scab$F1),
  seed = 127
)
all_scab_repeat_times_acc <- robust_kendall_perm(
  x = c(her2_scab$repeat_times, tnbc_scab$repeat_times),
