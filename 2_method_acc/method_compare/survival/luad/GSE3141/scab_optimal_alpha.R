...
setwd(
  "/home/yyx/R/Project/R_code/SigBridgeR/Tmp/method_compare/survival/luad/GSE3141"
)
...
surv_data = pheno %>%
  filter(`Array` %chin% colnames(bulk)) %>%
...
save_path = '/home/data/sigbridger/method_compare/survival/lung/GSE3141'
...
qs::qsave(para_list, file = "scAB_para_list.qs", nthreads = 4L) # 206590
