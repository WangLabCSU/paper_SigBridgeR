...
setwd(
  "/home/yyx/R/Project/R_code/SigBridgeR/Tmp/ssGSEA_negative_compare/survival/ov"
)
...
markers <- data.table::fread(
  "/home/yyx/R/Project/R_code/SigBridgeR/Tmp/ssGSEA_negative_compare/ov/ov_random20_markers_10rep.csv"
)
...
for (i in seq_len(ncol(markers))) {
  ...
  qs::qsave(es.mat, paste0("ov_", sample[i], "_ssgsea_score.qs"))
}
# PID=1000308
