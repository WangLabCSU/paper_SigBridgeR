...
setwd(
  '/home/yyx/R/Project/R_code/SigBridgeR/Tmp/ssGSEA_negative_compare/binary/ov/GSE9891'
)
...
bubble <- ggplot2::ggplot(
  ...
  ggplot2::labs(
    ...
    subtitle = "sc-GSE165897, bulk-GSE9891",
    y = "Mean ssGSEA Score",
    x = "Group"
  ) +
...
ggplot2::ggsave(
  filename = 'Sizable_Neg_ctrl_ov_GSE9891_mean_score.png',
  bubble,
  dpi = 400,
  width = 6,
  height = 6
