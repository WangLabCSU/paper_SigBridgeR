...
setwd(
  '/home/yyx/R/Project/R_code/SigBridgeR/Tmp/ssGSEA_negative_compare/survival/luad/GSE31210'
)
...
bubble <- ggplot2::ggplot(
  ...
  ggplot2::scale_size_continuous(
    ...
    range = c(1, 5), # 调整气泡大小范围
    limits = c(1, 5),
    breaks = log10(c(1, 10, 50, 100, 500, 1000, 5000, 10000, 50000) + 1), # 对数断点
    labels = c("1", "10", "50", "100", '500', "1K", '5K', "10K", "50K") # 原始数值标签
  ) +
  ...
  ggplot2::labs(
    ...
    subtitle = "sc-GSE123902, bulk-GSE31210",
    y = "Mean ssGSEA Score",
    x = "Group"
  ) +
...
ggplot2::ggsave(
  filename = 'Sizable_Neg_ctrl_luad_GSE31210_mean_score.png',
  bubble,
  dpi = 400,
  width = 6,
  height = 6
