...
cli::cli_alert_success(
  "Combined test results saved to {.file survival_ov_test_data.csv}"
)

# combined <- data.table::fread("survival_ov_test_data.csv")
...
htmap_dir <- "Tmp/ssGSEA_positive_compare/vis/survival/ov/heatmap"
