...
data_path = '/home/data/sigbridger/benchmark_data/lung/GSE8894'
seurat <- qs::qread(
  file.path(data_path, 'GSE8894_luad_merged_seurat.qs'),
  nthreads = 4L
)
...
# ! Warning: ! scissor only have one class, skip it !
# ! Warning: ! scPAS only have one class, skip it !
