...
setwd(
  "/home/yyx/R/Project/R_code/SigBridgeR/Tmp/ssGSEA_positive_compare/esmat/binary/ov/GSE9891"
)
...
seurat <- qs::qread(file.path(seurat_path, "GSE9891_hgsoc_merged_seurat.qs"))
...
# )
qs::qsave(es_df, file = "ssGSEA_score_GSE9891.qs", nthreads = 4L)
# 46143

score = qs::qread("ssGSEA_score_GSE9891.qs", nthreads = 4L)
score = score[, 1:2]
score = cbind(score, seurat[[]])
qs::qsave(score, file = "ssGSEA_score_GSE9891.qs", nthreads = 4L)
