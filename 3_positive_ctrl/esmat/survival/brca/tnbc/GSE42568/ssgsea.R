...
setwd(
  "/home/yyx/R/Project/R_code/SigBridgeR/Tmp/ssGSEA_positive_compare/esmat/survival/brca/tnbc/GSE42568"
)
...
score = qs::qread("ssGSEA_score_GSE42568.qs")
score = score[, 1:2]
score = cbind(score, seurat[[]])
qs::qsave(score, "ssGSEA_score_GSE42568.qs", nthreads = 4L)
