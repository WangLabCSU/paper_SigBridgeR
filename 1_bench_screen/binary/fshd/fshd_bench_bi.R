...
save_path <- "/home/data/sigbridger/benchmark_binary/fshd"
...
bulk_configs <- list(
  GSE56787 = list(
    bulk_qs = "fshd_bulkdata_GSE56787.qs",
    pheno_qs = "fshd_pheno_GSE56787.qs",
    ...
    methods = c(
      ...
      #   "DEGAS",
      "LP_SGL"
      #   , "PIPET" # Warning: ✖ No overlapping genes between markers and single-cell data,
    )
  ),
  GSE115650 = list(
    bulk_qs = "fshd_bulkdata_GSE115650.qs",
    pheno_qs = "fshd_pheno_GSE115650.qs",
    id_col = "geo_accession",
    label_col = "screen_label",
    methods = c(
      "Scissor",
      ...
      #   "DEGAS",
      "LP_SGL"
      # ,  "PIPET" # prediction is empty, please check the input data or adjust the      parameters
    )
  ),
  GSE140261 = list(
    bulk_qs = "fshd_bulkdata_GSE140261.qs",
    pheno_qs = "fshd_pheno_GSE140261.qs",
    id_col = "geo_accession",
    label_col = "screen_label",
    methods = c(
      "Scissor",
...
run_screening_pipeline <- function(
  ...
  out_file <- file.path(
    save_path,
    paste0("binary_fshd_", config_name, "_merged_seurat.qs")
  )
