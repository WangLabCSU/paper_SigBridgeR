...
setwd(
  "/home/yyx/R/Project/R_code/SigBridgeR/Tmp/method_compare/survival/luad/GSE8894"
)
...
pheno = data.table::fread(file.path(
  "/home/data/data-resource/single-cell/Lung_Cancer/LUAD/lung.cancer.adeno.gse8894.gpl570.tsv"
))
...
save_path = '/home/data/sigbridger/method_compare/survival/lung/GSE8894'
...
qs::qsave(para_list, file = "scAB_para_list.qs", nthreads = 4L) # 3539164
