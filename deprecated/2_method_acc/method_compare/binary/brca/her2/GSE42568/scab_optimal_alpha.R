...
setwd(
  "/home/yyx/R/Project/R_code/SigBridgeR/Tmp/method_compare/binary/brca/her2/GSE42568"
)
...
# * load data
seurat = qs::qread(file.path(data_path, "seurat_her2.qs"), nthreads = 4L)
...
save_path <- "/home/data/sigbridger/method_compare/binary/brca/her2/GSE42568"
...
# scab_obj <- qs::qread(
#     '/home/data/sigbridger/method_compare/binary/brca/her2/GSE42568/scab_obj.qs'
# )
