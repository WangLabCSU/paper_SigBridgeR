# ! 运行此脚本前，先运行/home/yyx/R/Project/R_code/SigBridgeR/Tmp/ssGSEA/test-her2/her2_ssGSEA_survival.R
# ! 把框架打好
...
col_anno_GSE162228_sur = CreateHtmapAnno.binary(
  GSE162228_survival,
  es.mat,
  "#cf7815ff"
)

GSE42569_binary = qs::qread(
...
ragg::agg_png(
  filename = file.path(plot_dir, "../ssGSEA_her2_ll_heatmap.png"),
  width = 1600,
  height = 1000
)
draw(
