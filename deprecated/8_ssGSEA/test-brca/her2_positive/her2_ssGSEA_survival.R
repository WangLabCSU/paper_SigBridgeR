...
# ! from CellMarker2.0, her2-positive breast cancer marker
markers <- data.table::fread(file.path(data_path, "her2_markers.csv"))
markers = list("Her2" = markers$HER2_positive_breast_cancer_marker)
...
qs::qsave(es.mat, "her2_ssgsea_score.qs") # PID=965591
...
plot_dir = "/home/yyx/R/Project/R_code/SigBridgeR/Tmp/ssGSEA/test-brca/her2_positive/plot"
...
pdf(
  file = file.path(plot_dir, "ssGSEA_her2_survival_heatmap.pdf"),
  width = 16,
  height = 10
)
draw(
