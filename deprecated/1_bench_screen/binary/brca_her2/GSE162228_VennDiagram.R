...
GSE162228_scissor_result = qs::qread(
  file.path(data_path, "binary_her2_GSE162228_scissor_result.qs"),
  nthreads = 4
)
...
GSE162228_scab_result = qs::qread(
  file.path(data_path, "binary_her2_GSE162228_scab_result.qs"),
  nthreads = 4
)
...
GSE162228_scpas_result = qs::qread(
  file.path(data_path, "binary_her2_GSE162228_scpas_result.qs"),
  nthreads = 4
)
...
GSE162228_scpp_result = qs::qread(
  file.path(data_path, "binary_her2_GSE162228_scpp_result.qs"),
  nthreads = 4
)
...
GSE162228_lp_sgl_result = qs::qread(
  file.path(data_path, "binary_her2_GSE162228_lp_sgl_result.qs"),
  nthreads = 4
)

GSE162228_degas_result = qs::qread(
  file.path(data_path, "binary_her2_GSE162228_degas_result.qs"),
  nthreads = 4
)
...
qs::qsave(
  seurat_merged,
  file.path(data_path, "GSE162228_brca_merged_seurat.qs"),
  nthreads = 4L
)
...
ggplot2::ggsave("GSE162228_her2_Upset.png", upset, width = 11, height = 11)
