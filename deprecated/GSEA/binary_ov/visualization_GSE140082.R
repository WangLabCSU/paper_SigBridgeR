...
setwd(file.path(usethis::proj_path(), "/Tmp/GSEA/binary_ov"))
...
#   "/home/data/sigbridger/GSEA/lung/ov_irGSEA_score.qs",
#   nthreads = 8L
# )

dge <- qs::qread(
  "/home/data/sigbridger/GSEA/binary_ov/binary_ov_GSE140082_dge.qs",
  nthreads = 8L
)
...
plot_dir <- "binary_plot_GSE140082"
