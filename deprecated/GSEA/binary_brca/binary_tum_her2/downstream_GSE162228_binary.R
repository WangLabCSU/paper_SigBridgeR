...
data_path <- "/home/data/sigbridger/GSEA/binary_brca/her2"
...
irgsea_score <- SigBridgeR::MergeResult(irgsea_score, her2_GSE162228_merged)
...
if (file.exists(file.path(data_path, "binary_her2_GSE162228_dge.qs"))) {
  dge_res <- qs::qread(
    file.path(data_path, "binary_her2_GSE162228_dge.qs"),
    nthreads = 4L
  )
