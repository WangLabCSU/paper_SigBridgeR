...
setwd(
  "/home/yyx/R/Project/R_code/SigBridgeR/Tmp/ssGSEA_negative_compare/luad"
)
...
markers <- data.table::fread(
  "/home/yyx/R/Project/R_code/SigBridgeR/Tmp/ssGSEA_negative_compare/luad/luad_random20_markers_10rep.csv"
)
