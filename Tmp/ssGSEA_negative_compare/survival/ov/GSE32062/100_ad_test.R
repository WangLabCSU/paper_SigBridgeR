...
scores <- data.table::fread(
  "Tmp/ssGSEA_negative_compare/survival/ov/GSE32062/ov_sur_100reps_neg_ctrl_stat.csv"
)
...
results <- results %>%
  ...
  data.table::fwrite(results,"Tmp/ssGSEA_negative_compare/survival/ov/GSE32062/rep100_ad_results.csv")
