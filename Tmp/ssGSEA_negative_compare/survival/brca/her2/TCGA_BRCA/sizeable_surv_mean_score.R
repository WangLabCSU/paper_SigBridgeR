...
setwd(
  '/home/yyx/R/Project/R_code/SigBridgeR/Tmp/ssGSEA_negative_compare/survival/brca/her2/TCGA_BRCA'
)

score_path <- '/home/yyx/R/Project/R_code/SigBridgeR/Tmp/ssGSEA_negative_compare/brca'
score_name <- paste0('her2_Sample_', 1:10, '_ssgsea_score')
...
MeanScore = function(seurat_obj, es.mat, sample = "GSE", i = NULL) {
  ...
  mean_scores_pipet <- calculate_counts(es.df, "PIPET")
...
bubble <- ggplot2::ggplot(
  ...
  ggplot2::labs(
    ...
    subtitle = "sc-GSE161529 HER2, bulk-TCGA_BRCA",
    y = "Mean ssGSEA Score",
    x = "Group"
  ) +
...
ggplot2::ggsave(
  filename = 'Sizable_Neg_ctrl_her2_TCGA_BRCA_mean_score.png',
  bubble,
  dpi = 400,
  width = 6,
  height = 6
