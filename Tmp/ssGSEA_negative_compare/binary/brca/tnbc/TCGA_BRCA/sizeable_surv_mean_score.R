...
setwd(
  '/home/yyx/R/Project/R_code/SigBridgeR/Tmp/ssGSEA_negative_compare/binary/brca/tnbc/TCGA_BRCA'
)
...
bubble <- ggplot2::ggplot(
  ...
  ggplot2::labs(
    ...
    subtitle = "sc-GSE161529 TNBC, bulk-TCGA_BRCA",
    y = "Mean ssGSEA Score",
    x = "Group"
  ) +
...
ggplot2::ggsave(
  filename = 'Sizable_Neg_ctrl_tnbc_TCGA_BRCA_mean_score.png',
  bubble,
  dpi = 400,
  width = 6,
  height = 6
