...
scores <- data.table::fread(
  "Tmp/ssGSEA_negative_compare/binary/luad/TCGA_LUAD/luad_bi_100reps_neg_ctrl_stat.csv"
)
...
data.table::fwrite(results,"Tmp/ssGSEA_negative_compare/binary/luad/TCGA_LUAD/rep100_ad_results.csv")
