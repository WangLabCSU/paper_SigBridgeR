...
GSE42568_scissor_result = qs::qread(
  file.path(data_path, "binary_her2_GSE42568_scissor_result.qs"),
  nthreads = 4
)
...
GSE42568_scab_result = qs::qread(
  file.path(data_path, "binary_her2_GSE42568_scab_result.qs"),
  nthreads = 4
)
...
GSE42568_scpas_result = qs::qread(
  file.path(data_path, "binary_her2_GSE42568_scpas_result.qs"),
  nthreads = 4
)
...
GSE42568_degas_result = qs::qread(
  file.path(data_path, "binary_her2_GSE42568_degas_result.qs"),
  nthreads = 4
)

GSE42568_lp_sgl_result = qs::qread(
  file.path(data_path, "binary_her2_GSE42568_lp_sgl_result.qs"),
  nthreads = 4
)

GSE42568_pipet_result = qs::qread(
  file.path(data_path, "binary_her2_GSE42568_pipet_result.qs"),
  nthreads = 4
)
...
ggplot2::ggsave("GSE42568_her2_Upset.png", upset, width = 11, height = 11)
