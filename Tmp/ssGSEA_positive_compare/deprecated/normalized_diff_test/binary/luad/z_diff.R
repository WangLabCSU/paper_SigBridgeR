...
esmat_root <- "/home/yyx/R/Project/R_code/SigBridgeR/Tmp/ssGSEA_positive_compare/normalized_esmat/binary/luad"
...
purrr::walk(
  ...
  function(bulk_i) {
    ...
    file_name <- paste0("z_diff_", bulk_i, "_", type_pheno, ".csv")
