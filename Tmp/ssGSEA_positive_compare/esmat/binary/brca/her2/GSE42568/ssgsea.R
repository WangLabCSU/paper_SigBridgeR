...
setwd(
  "/home/yyx/R/Project/R_code/SigBridgeR/Tmp/ssGSEA_positive_compare/esmat/binary/brca/her2/GSE42568"
)
...
markers_file_names <- "binary_deg_her2_GSE42568.csv"
...
seurat <- qs::qread(file.path(seurat_path, "GSE42568_brca_merged_seurat.qs"))
