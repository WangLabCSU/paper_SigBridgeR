...
setwd(
  "/home/yyx/R/Project/R_code/SigBridgeR/Tmp/ssGSEA_positive_compare/esmat/binary/brca/her2/GSE162228"
)
...
seurat <- qs::qread(file.path(seurat_path, "GSE162228_brca_merged_seurat.qs"))
