...
diff_path <- "/home/yyx/R/Project/R_code/SigBridgeR/Tmp/ssGSEA_positive_compare/diff_test/binary/brca/her2"
...
esmat_root <- "/home/yyx/R/Project/R_code/SigBridgeR/Tmp/ssGSEA_positive_compare/esmat/binary/brca/her2"
...
data.table::fwrite(
  combined,
  file = "binary_her2_test_data.csv"
)
