...
diff_path <- "/home/yyx/R/Project/R_code/SigBridgeR/Tmp/ssGSEA_positive_compare/diff_test/binary/brca/tnbc"
...
esmat_root <- "/home/yyx/R/Project/R_code/SigBridgeR/Tmp/ssGSEA_positive_compare/esmat/binary/brca/tnbc"
...
data.table::fwrite(
  combined,
  file = "binary_tnbc_test_data.csv"
)

cli::cli_alert_success(
  "Combined test results saved to {.file binary_tnbc_test_data.csv}"
)
...
purrr::walk(
  ...
  function(ssgsea_type) {
    ...
    p <- ggplot(plot_df2) +
      ...
      labs(
        title = "TNBC ssGSEA Pos Ctrl",
        subtitle = glue::glue(
          "sc GSE161529 TNBC ; {ssgsea_type} marker \nbinary phenotype\nGSE42568: Tumor/Normal; GSE162228: Tumor/Normal; \nTCGA_BRCA: Tumor/Normal"
        )
      ) +
      theme(
...
purrr::walk(c("pos", "neg"), function(ssgsea_type) {
  file_name <- glue::glue("tnbc_{ssgsea_type}marker_htmap.png")
