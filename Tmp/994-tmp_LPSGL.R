...
# )
devtools::document('/home/yyx/R/Project/R_code/SigBridgeR_methods/LP_SGL')
leiden_res = run_leiden_clustering(seurat)
res = label_cell(seurat, bulk, pheno, leiden_res, type = 'cox')

qs::qsave(res, "lpsgl_result.qs")

LoadEnv()
lpsgl_result = qs::qread(file.path(data_path, "lpsgl_result.qs"))

SaveEnv('/home/data/sigbridger')
# 3362275
