...
# ! brca-GSE161529_tnbc, bulk-GSE42569, survival as phenotype
...
plot_dir = "/home/yyx/R/Project/R_code/SigBridgeR/Tmp/ssGSEA/test-brca/tnbc/plot"
...
ragg::agg_png(
  filename = file.path(plot_dir, "ssGSEA_survival_tnbc_heatmap.png"),
  width = 1600,
  height = 1000
)
draw(
