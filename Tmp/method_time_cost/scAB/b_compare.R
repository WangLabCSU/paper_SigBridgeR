...
output_dir <- "/home/data/sigbridger/method_time_cost/scAB"
...
qs::qsave(
  survival_tweaked,
  file.path(output_dir, "scAB_survival_bench.qs"),
  nthreads = 2L
)
...
qs::qsave(
  binary_tweaked,
  file.path(output_dir, "scAB_binary_bench.qs"),
  nthreads = 2L
)


cli::cli_alert_info("Finished benchmarking scAB!")
