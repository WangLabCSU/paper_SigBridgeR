...
output_dir <- "/home/data/sigbridger/method_time_cost/scissor"
...
qs::qsave(
  survival_tweaked,
  file.path(output_dir, "scissor_survival_bench.qs"),
  nthreads = 2L
)
...
qs::qsave(
  binary_tweaked,
  file.path(output_dir, "scissor_binary_bench.qs"),
  nthreads = 2L
)


cli::cli_alert_info("Finished benchmarking scissor!")
