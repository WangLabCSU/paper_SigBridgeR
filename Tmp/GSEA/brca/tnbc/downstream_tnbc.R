...
labeled_irgsea = SigBridgeR::MergeResult(irgsea_score, tnbc_GSE42568)
...
qs::qsave(
  ...
  file = "tnbc_GSE42568_dge_result.qs",
  nthreads = 4L
)
# PID='2392475'

dge_res = qs::qread(file.path(save_path, "tnbc_GSE42568_dge_result.qs"))
dge_res$scab = scab.dge
qs::qsave(
  dge_res,
  file.path(save_path, "tnbc_GSE42568_dge_result.qs"),
  nthreads = 4L
)
