...
data_path <- "/home/data/sigbridger/GSEA/binary_brca/tnbc"
...
irgsea_score <- SigBridgeR::MergeResult(irgsea_score, tnbc_GSE162228_merged)
...
if (file.exists(file.path(data_path, "binary_tnbc_GSE162228_dge.qs"))) {
  dge_res <- qs::qread(
    file.path(data_path, "binary_tnbc_GSE162228_dge.qs"),
    nthreads = 4L
  )
