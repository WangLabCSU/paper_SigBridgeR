...
irgsea_score <- SigBridgeR::MergeResult(irgsea_score, tnbc_GSE42568_merged)
...
if (file.exists(file.path(data_path, "binary_tnbc_GSE42568_dge.qs"))) {
  dge_res <- qs::qread(
    file.path(data_path, "binary_tnbc_GSE42568_dge.qs"),
    nthreads = 4L
  )
