...
luad_GSE31210 <- qs::qread(
  "/home/data/sigbridger/benchmark_data/lung/GSE31210/GSE31210_luad_merged_seurat.qs",
  nthreads = 8L
)

irgsea_score <- SigBridgeR::MergeResult(irgsea_score, luad_GSE31210)
...
if (file.exists(file.path(data_path, "luad_GSE31210_dge_result.qs"))) {
  dge_res <- qs::qread(
    file.path(data_path, "luad_GSE31210_dge_result.qs"),
    nthreads = 4L
  )
