...
dge = qs::qread(
  "/home/data/sigbridger/GSEA/lung/luad_GSE8894_dge_result.qs",
  nthreads = 8L
)
...
if (!dir.exists("survival_plot_GSE8894")) {
  dir.create("survival_plot_GSE8894")
}
purrr::imap(bubbles, function(dataset_list, dataset_name) {
  ...
  purrr::imap(dataset_list, function(plot_obj, i) {
    ...
    filepath <- file.path("survival_plot_GSE8894", filename)
